...
def calc_icp(velodyne_frame, velodyne_frame_prev, frame_idx, folder):
    ...
    :param folder: the folder in which to save the comparison of the cloud before and after ICP is applied
                   if the folder argument is None, the image is simply shown as prompt
    ...
    for config in configs:
        ...
        for frame_idx in range(frame_count):
            ...
            if apply_icp and frame_idx > 0:
                ...
                e_icp_diff, n_icp_diff, yaw_icp_diff, RR, tt = calc_icp(velodyne_frame_transformed_and_filtered_for_icp, velodyne_frame_prev_transformed_and_filtered_for_icp, frame_idx, config['folder'])
